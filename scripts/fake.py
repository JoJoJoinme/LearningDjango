...
if __name__ == '__main__':
    ...
    category_list = ['Python学习笔记', '开源项目', '工具资源', '生活杂谈', 'test category']
    tag_list = ['Python', 'Django', 'pipenv', 'Docker', 'Nginx', 'ElasticSearch']
    a_year_ago = timezone.now() - timedelta(days=365)

    print('create Categorys and Tags')
    ...
    for _ in range(100):
        ...
        post.save()
    print('Generate Chinese fake article')
    ...
    for _ in range(100):
        ...
        post.tags.add(tag1, tag2)
        post.save()
    print('Generating Chinese article finished')
